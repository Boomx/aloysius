    ...
    CandidateProfilePage.prototype.editCandidate = function () {
        ...
        modal.onDidDismiss(function (resp) {
            if (resp) {
                ...
                _this.candidateService.updateCandidateStatus(resp).subscribe(function (resp) {
                    _this.loader.dismiss();
                });
            }
        });
